        ...
        <div className="flex justify-between h-20 items-center">
          ...
          <div className="hidden md:flex items-center gap-8">
            <a
              ...
              className="text-[#FF7A00] animate-pulse hover:text-orange-700 font-black transition-colors uppercase text-sm tracking-wider flex items-center gap-1"
            >
              <Zap className="w-4 h-4" /> Ofertas Exclusivas
            </a>
            <a
              href="#productos"
              className="text-slate-600 hover:text-[#FF7A00] font-semibold transition-colors uppercase text-sm tracking-wider"
            >
              Equipos
            </a>
            <a
            ...
            <a
              href={PHONE_TEL}
              className="flex items-center gap-2 bg-[#FF7A00] text-white px-6 py-3 rounded-xl font-bold hover:bg-orange-600 transition-all shadow-lg shadow-orange-500/20 active:scale-95 group"
            >
        ...
        <div className="md:hidden bg-white border-b border-slate-200 p-4 animate-in slide-in-from-top duration-300">
          <div className="flex flex-col gap-4">
            <a
              ...
              className="text-lg font-black text-[#FF7A00] p-2 uppercase flex items-center gap-2 bg-orange-50 rounded-xl"
            >
            ...
            <a
              href="#productos"
              onClick={() => setIsOpen(false)}
              className="text-lg font-bold text-slate-700 p-2 uppercase"
            >
              Equipos
            </a>
            <a
            ...
            <a
              href={PHONE_TEL}
              className="bg-[#FF7A00] text-white p-4 rounded-xl text-center font-bold flex items-center justify-center gap-2"
            >
  ...
  if (submitted) {
    return (
      <div className="bg-white p-8 rounded-3xl shadow-2xl text-center animate-in zoom-in duration-300">
        ...
        <p className="text-slate-600 mt-2 italic font-bold">
          Un experto de Power Solar te llamará pronto.
        </p>
        <button
          onClick={() => {
            setSubmitted(false);
          ...
          className="mt-4 text-[#FF7A00] font-bold underline"
        >
          Enviar otro
        </button>
      </div>
    ...
    <div className="bg-white p-6 sm:p-8 rounded-3xl shadow-2xl border border-slate-100">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {showTowns && (
              <div className="absolute z-50 w-full mt-1 bg-slate-900 border border-slate-700 rounded-xl max-h-48 overflow-y-auto shadow-2xl">
                {PUERTO_RICO_TOWNS.filter((t) =>
                  ...
                  <div
                    key={t}
                    className="px-4 py-3 hover:bg-orange-600 cursor-pointer text-white border-b border-slate-800 last:border-0"
                    onClick={() => {
                      setFormData({ ...formData, town: t });
                      setTownSearch(t);
                      setShowTowns(false);
                    }}
                  >
        ...
        <button
          disabled={loading}
          type="submit"
          className="w-full bg-[#FF7A00] text-white font-black py-4 rounded-xl shadow-lg flex items-center justify-center gap-2 text-xl active:scale-95 uppercase hover:bg-orange-600 transition-colors disabled:opacity-50"
        >
    ...
    <div className="max-w-7xl mx-auto px-4 text-center">
        ...
        <div className="text-left space-y-6">
          ...
          <ul className="space-y-4">
            <li className="flex gap-4 p-5 bg-slate-50 rounded-xl border border-slate-100 italic">
              ...
              <span>
                <strong>Bifacial:</strong> Captura sol por ambos lados, rindiendo hasta 30% más en techos blancos.
              </span>
            </li>
            <li className="flex gap-4 p-5 bg-slate-50 rounded-xl border border-slate-100 italic">
              <Wind className="text-[#FF7A00] shrink-0" />
              <span>
                <strong>Resistencia:</strong> Estructuras de aluminio certificadas para vientos huracanados.
              </span>
            </li>
          </ul>
        </div>
      ...
      <div className="grid lg:grid-cols-2 gap-16 items-center">
        <div className="text-left space-y-6 order-2 lg:order-1">
          ...
          <ul className="space-y-4">
            <li className="flex gap-4 p-5 bg-slate-50 rounded-xl border border-slate-100 italic">
              ...
              <span>
                <strong>Backup Total:</strong> Enciende aire acondicionado y calentadores sin problemas.
              </span>
            </li>
            <li className="flex gap-4 p-5 bg-slate-50 rounded-xl border border-slate-100 italic">
              <Battery className="text-[#FF7A00] shrink-0" />
              <span>
                <strong>Control Total:</strong> App Tesla para ver tu ahorro en tiempo real.
              </span>
            </li>
          </ul>
        </div>
        ...
        <img
          ...
          className="w-[60%] mx-auto order-1 lg:order-2 transform hover:scale-105 transition-transform"
        />
      </div>
    </div>
  </section>
      ...
      <div className="text-center lg:text-left space-y-6">
        ...
        <div className="flex flex-wrap justify-center lg:justify-start gap-4 pt-4">
          <span className="bg-white border px-4 py-2 rounded-full text-xs font-bold flex items-center gap-2 shadow-sm">
            ...
            Financiamiento 100% Local
          </span>
          <span className="bg-green-100 text-green-700 px-4 py-2 rounded-full text-xs font-bold shadow-sm flex items-center gap-2">
...
const ApartmentBatteries = () => (
  <section className="py-24 bg-slate-900 text-white overflow-hidden relative">
    <div className="max-w-7xl mx-auto px-4 grid lg:grid-cols-2 gap-16 items-center relative z-10">
      ...
      <img
        src="https://raw.githubusercontent.com/jerrysocialmediapr-ctrl/Power-Solar/main/DeltaProUltra.png"
  ...
  <section className="py-24 bg-[#FF7A00] text-white text-center">
    <div className="max-w-4xl mx-auto px-4 space-y-8">
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-center pt-6">
        <a
          href="#form-hero"
          className="bg-white text-[#FF7A00] px-12 py-5 rounded-2xl font-black text-xl uppercase shadow-2xl"
        >
          ¡Cotizar Gratis!
        </a>
        <a
          href={PHONE_TEL}
          className="bg-slate-900 text-white px-12 py-5 rounded-2xl font-black text-xl uppercase shadow-2xl flex items-center justify-center gap-2"
        >
          <Phone /> ¡Llamar!
        </a>
      </div>
  ...
  return (
    <div className="min-h-screen bg-slate-50 selection:bg-orange-100 overflow-x-hidden">
      ...
      <footer className="bg-slate-900 text-white py-12 text-center">
        <p className="text-slate-500 text-xs font-bold uppercase italic tracking-widest">
          Power Solar PR © {new Date().getFullYear()}
        </p>
      </footer>
    </div>
  );
